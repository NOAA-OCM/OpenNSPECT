Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("clsWQStd_NET.clsWQStd")> Public Class clsWQStd
	...
	' *  clsWQStd
	' *************************************************************************************
	' *  Description: Class that defines the Water Quality menu in the N-Spect advanced settings menu
	' *
	' *
	' *  Called By:
	' *************************************************************************************
	...
	Const c_sModuleFileName As String = "clsWQStd.cls"
...
ErrorHandler: 
	...
	Private ReadOnly Property ICommand_Caption() As String Implements ESRI.ArcGIS.SystemUI.ICommand.Caption
		Get
			...
			ICommand_Caption = "Water Quality Standards..."
...
ErrorHandler: 
	...
	Private ReadOnly Property ICommand_Message() As String Implements ESRI.ArcGIS.SystemUI.ICommand.Message
		Get
			...
			ICommand_Message = "Water Quality Standards"
...
ErrorHandler: 
	...
	Private ReadOnly Property ICommand_Tooltip() As String Implements ESRI.ArcGIS.SystemUI.ICommand.Tooltip
		Get
			...
			ICommand_Tooltip = "Choose Water Quality Standards"
