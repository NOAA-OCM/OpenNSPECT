...
ErrorHandler: 
	...
	Private Function ConstructMetaData(ByRef rsType As ADODB.Recordset, ByRef strCoeffSet As String, ByRef booLocal As Boolean) As String
	...
	Private Function ConstructConStatment(ByRef rsType As ADODB.Recordset, ByRef pLCRaster As ESRI.ArcGIS.Geodatabase.IRaster) As String
...
ErrHandler: 
	...
	Private Function CompareWaterQuality(ByRef pWSFeatureClass As ESRI.ArcGIS.Geodatabase.IFeatureClass, ByRef pPollutantRaster As ESRI.ArcGIS.Geodatabase.IRaster) As Boolean
