Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("clsPrecip_NET.clsPrecip")> Public Class clsPrecip
	...
	' *  clsPrecip
	' *************************************************************************************
	' *  Description: Class that defines the main choice "Precipitation Scnenaios" in the
	' *  advanced settings
	' *
	' *  Called By: Precipitation Scenarios menu
	' *************************************************************************************
	' *  Subs:
	' *
	' *  Misc:
	...
	Const c_sModuleFileName As String = "clsPrecip.cls"
...
ErrorHandler: 
	...
	Private ReadOnly Property ICommand_Caption() As String Implements ESRI.ArcGIS.SystemUI.ICommand.Caption
		Get
			...
			ICommand_Caption = "Precipitation Scenarios..."
...
ErrorHandler: 
	...
	Private ReadOnly Property ICommand_Message() As String Implements ESRI.ArcGIS.SystemUI.ICommand.Message
		Get
			...
			ICommand_Message = "Precipitation Scenarios"
...
ErrorHandler: 
	...
	Private ReadOnly Property ICommand_Name() As String Implements ESRI.ArcGIS.SystemUI.ICommand.Name
		Get
			...
			ICommand_Name = "N-SPECTToolPrecip"
...
ErrorHandler: 
	...
	Private ReadOnly Property ICommand_Tooltip() As String Implements ESRI.ArcGIS.SystemUI.ICommand.Tooltip
		Get
			...
			ICommand_Tooltip = "Choose a precipitation scenario"
...
ErrorHandler: 
	...
	Private Sub ICommand_OnClick() Implements ESRI.ArcGIS.SystemUI.ICommand.OnClick
		...
		frmPrecip.init(m_App)
		frmPrecip.ShowDialog()
