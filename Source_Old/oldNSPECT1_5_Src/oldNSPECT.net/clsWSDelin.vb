Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("clsWSDelin_NET.clsWSDelin")> Public Class clsWSDelin
	...
	' *  clsWSDelin
	' *************************************************************************************
	' *  Description: Class that defines the watershed delineation sub-menu in the N-Spect menu
	' *
	' *
	' *  Called By:
	' *************************************************************************************
	...
	Const c_sModuleFileName As String = "clsWSDelin.cls"
...
ErrorHandler: 
	...
	Private ReadOnly Property ICommand_Caption() As String Implements ESRI.ArcGIS.SystemUI.ICommand.Caption
		Get
			...
			ICommand_Caption = "Watershed Delineations..."
...
ErrorHandler: 
	...
	Private ReadOnly Property ICommand_Message() As String Implements ESRI.ArcGIS.SystemUI.ICommand.Message
		Get
			...
			ICommand_Message = "Watershed Delineations"
...
ErrorHandler: 
	...
	Private ReadOnly Property ICommand_Tooltip() As String Implements ESRI.ArcGIS.SystemUI.ICommand.Tooltip
		Get
			...
			ICommand_Tooltip = "Delineate a watershed"
...
ErrorHandler: 
	...
	Private Sub ICommand_OnClick() Implements ESRI.ArcGIS.SystemUI.ICommand.OnClick
		...
		frmWSDelin.init(m_App)
		frmWSDelin.ShowDialog()
