...
Namespace Xml
    ...
    Public Class OutputItems
        ...
        Public Property Item(ByVal Index As Integer) As OutputItem
            Get
                'Get the order item at the given index.
                Item = m_colItems.Item(Index)
            End Get
            Set(ByVal Value As OutputItem)
        ...
        'Add an order item.
        Public Sub Add(ByVal OutItem As OutputItem)
