...
Module modLanduse
    ...
    Private Function CopyCoefficient(ByRef strNewCoeffName As String, ByRef strCoeffSet As String) As OleDbCommand
        '        On Error GoTo ErrHandler
    ...
    Private Function ReclassRaster(ByRef clsLUItem As clsXMLLandUseItem, ByRef strLCClass As String) As MapWinGIS.Grid
