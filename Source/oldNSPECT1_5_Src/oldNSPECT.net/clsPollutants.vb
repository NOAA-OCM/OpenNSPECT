Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("clsPollutants_NET.clsPollutants")> Public Class clsPollutants
	...
	' *  clsHelp
	' *************************************************************************************
	' *  Description:  Class for Pollutants... menu option off NSPECT advanced settings menu
	' *
	' *
	' *  Called By:  Pollutants... menu
	' *************************************************************************************
	
	' Define a class module for menu choice Pollutants...
	Private m_App As ESRI.ArcGIS.Framework.IApplication
	Const c_sModuleFileName As String = "clsPollutants.cls"
...
ErrorHandler: 
	...
	Private ReadOnly Property ICommand_Name() As String Implements ESRI.ArcGIS.SystemUI.ICommand.Name
		Get
			...
			ICommand_Name = "N-SPECTToolPollutants"
...
ErrorHandler: 
	...
	Private ReadOnly Property ICommand_Tooltip() As String Implements ESRI.ArcGIS.SystemUI.ICommand.Tooltip
		Get
			...
			ICommand_Tooltip = "Choose Pollutants"
...
ErrorHandler: 
	...
	Private Sub ICommand_OnClick() Implements ESRI.ArcGIS.SystemUI.ICommand.OnClick
		...
		frmPollutants.init(m_App)
		frmPollutants.ShowDialog()
